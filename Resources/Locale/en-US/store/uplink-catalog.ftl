...
uplink-encryption-key-desc = An encryption key that not only allows you to listen into all station-side radio channels, but also allows you to use a secure Syndicate channel to contact other agents.
...
uplink-syndicate-stamp-name = Syndicate Rubber Stamp #In loving memory, Btamp, ???-1/31/23
